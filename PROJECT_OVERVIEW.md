# Project Overview: YouTube Ad Recommendation

## Problem Statement

YouTube needs to maximize Click-Through Rate (CTR) by recommending the right ads to the right users. This project builds a machine learning system to predict which YouTube advertisements are most likely to be clicked, enabling better ad recommendations and higher campaign ROI.
...
### Short-term
- [x] Add more features (C14-C21, device_conn_type)
...
1. **Feature Hashing**: Effective for high-cardinality categoricals
